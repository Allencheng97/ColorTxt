...
| `SettingsGeneralPanel.vue`                           | 「常规」：启动恢复上次文件、同步当前文件、历史条数、电子书转换缓存目录、**书包解压目录**、章节最少字数、**数据管理**（**阅读数据** `icons.read` + **清除缓存** `icons.clear`）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
